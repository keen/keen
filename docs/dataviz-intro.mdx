...
<iframe width="100%" height="400" src="//jsfiddle.net/maciejrybaniec/f7uqs5oa/9/embedded/result,js,html/" allowFullScreen="allowfullscreen" allowpaymentrequest="true" frameBorder="0"></iframe>
...
<Story id="visualizations-pie-chart-dataviz--own-data" height="550px" />
